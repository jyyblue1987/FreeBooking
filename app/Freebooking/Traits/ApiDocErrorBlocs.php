...
namespace App\Freebooking\Traits;
...
trait ApiDocErrorBlocs {
    ...
    /**
     * @apiDefine LeagueGameVenueNotFound
     * @apiError (Error 404) LeagueDetailsNotFound The league game venue was not found
     *
     * @apiErrorExample {json} LeagueGameVenueNotFound
     *     HTTP/1.1 404 Not Found
     *     {
     *       "error": {
    ...
    /**
     * @apiDefine LeagueSeasonNotFound
     * @apiError (Error 404) LeagueSeasonNotFound The <code>id</code> of the League season was not found.
     *
     * @apiErrorExample {json} LeagueSeasonNotFound
     *     HTTP/1.1 404 Not Found
     *     {
     *       "error": {
