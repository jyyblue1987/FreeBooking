...
namespace App\Freebooking\Contracts;
...
interface HTTPStatusCode {
    ...
    /**
     * Freebooking is down or being upgraded.
     */
    const BAD_GATEWAY = 502;

    /**
     * The Freebooking servers are up, but overloaded with requests. Try again later.
     */
    const SERVICE_UNAVAILABLE = 503;

    /**
     * The Freebooking servers are up, but the request couldn't be serviced due to some failure within our stack. Try again later.
     */
