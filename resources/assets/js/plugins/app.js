...
!function () {
    ...
    angular.module("app.ui.form.ctrls", []).controller("UISelectDemoCtrl", ["$scope", function ($s) {
    ...
    }]).controller("FormWizardCtrl", ["$scope","$http", function ($scope, $http) {
        ...
        $scope.steps = [!0, !1, !1], $scope.stepNext = function (index, action) {
           ...
           /* $http({
                method  : 'POST',
                url     : 'hotels',
                data    : $scope.person, //forms user object
...
return;*/
           ...
           //ugly fix
            ...
            if(action == 'user'){
                ...
                userData.push($scope.person);
            }else if(action == 'hotel'){

                hotelData.push($scope.hotel);

            }else if(action == 'saveData'){

                $scope.setRoutes("hotels");
