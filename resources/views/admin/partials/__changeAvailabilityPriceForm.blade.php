...
<div class="form-group mb0" ng-controller="DatepickerCtrl">
    ...
    <div class="col-lg-4">
        <div class="input-group">
            <input type="text" class="form-control" ng-model="price.from" name="from" datepicker-popup is-open="fromOpened" min-date="minDate" max-date="'2025-06-22'" datepicker-options="dateOptions" date-disabled="disabled(date, mode)" ng-required="true" show-button-bar="false" placeholder="From" >
    ...
    <div class="col-lg-4">
        <div class="input-group mb0">
            <input type="text" class="form-control" ng-model="price.to" name="to" datepicker-popup is-open="toOpened" min-date="minDate" max-date="'2025-06-22'" datepicker-options="dateOptions" date-disabled="disabled(date, mode)" ng-required="true" show-button-bar="false" placeholder="Until" >
            <span class="input-group-btn">
