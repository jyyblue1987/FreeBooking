...
<form  name="wizard-step-2" class="form-horizontal col-lg-10 ng-pristine ng-valid" style="" ng-submit="addHotel()" ng-init="loadHotelData()">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-8">
            <rating ng-model="hotel.overStar" name="overStar" max="5" readonly="isReadonly" on-hover="hoveringOver(value)" on-leave="overStar = null" state-on="'fa fa-star'" state-off="'fa fa-star-o'"></rating>
        </div>
    </div>
