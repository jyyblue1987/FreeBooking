<form  name="wizard-step-2" class="form-horizontal col-lg-12 ng-pristine ng-valid" style="" ng-submit="addHotelSettings()" ng-init="loadHotelSettings()">
    <div class="row">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8 col-lg-offset-4 padding-6">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2 col-lg-offset-4 padding-6">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2>Payment options in the hotel</h2>
            </div>
        </div>
        <hr class="dashed mb30">
...
<hr class="dashed mb30">
    <div class="form-group">
        ...
        <label class="col-lg-5"><b>Reserve without credit card</b></label>
    ...
    <div class="form-group">
        ...
        <label class="col-lg-5"><b>Check-in form</b></label>
    ...
    <div class="form-group">
        ...
        <label class="col-lg-5"><b>Tourist tax</b></label>
    ...
    <div class="form-group">
        ...
        <label class="col-lg-5"><b>Received invoices by Freebookings.nl</b></label>
    ...
    <div class="form-group">
        ...
        <label class="col-lg-5"><b>Receive reservations by Freebookings.nl</b></label>
...
<hr class="dashed mb30">
    ...
    <div class="form-group">
        ...
        <label class="col-lg-5"><b>Would you like to receive a message, when no rooms/arrangements are available anymore?</b></label>
    ...
    <div class="form-group">
        ...
        <label class="col-lg-5"><b>Would you like to receive a message with a guest list (arrivals this morning)?</b></label>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2>Control engine page display setting.</h2>
        </div>
    </div>
    <hr class="dashed mb30">
