        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <div class="input-group mb0">
                    ...
                    <input type="text" ng-model="price.cost" min="1" placeholder="Set Price" class="form-control" name="cost" numeric-validity required>
                </div>
                    ...
                    <tr ng-repeat="data in suData track by $index">
                        ...
                        <td class="action-td">
                            <div class="btn-group btn-group-sm action-buttons">
                                ...
                                <button type="button" class="btn btn-sm btn-default" title="Edit" ng-click="editSu(data.uid,  data.ref_id, data.start, data.end, data.price)"><i class="fa fa-edit"></i></button>

                                <button type="button" class="btn btn-sm btn-default" title="delete" ng-click = "deleteSu('Single-Use', 'Price set-up deleted!', data.uid, data.ref_id, data.start, data.end)"><i class="fa fa-trash"></i></button>
